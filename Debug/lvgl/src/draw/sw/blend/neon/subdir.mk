...
lvgl/src/draw/sw/blend/neon/%.o: ../lvgl/src/draw/sw/blend/neon/%.S lvgl/src/draw/sw/blend/neon/subdir.mk
	arm-none-eabi-gcc -mcpu=cortex-m4 -g3 -DDEBUG -c -I"D:/Studies/0myfiles/STM32L476/Controller/lvgl/src" -x assembler-with-cpp -MMD -MP -MF"$(@:%.o=%.d)" -MT"$@" --specs=nano.specs -mfpu=fpv4-sp-d16 -mfloat-abi=hard -mthumb -o "$@" "$<"
